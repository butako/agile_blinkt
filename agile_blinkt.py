...
"""
    ...
    This script is designed to be used with the Pimoroni Blinkt LED board,
    Octopus Energy Agile price tariff, and a live power consumption/export
    feed (e.g. from Open Emon CMS).

    This will display a Larson oscillating LED display (aka Knight Rider car)
    that changes speed and changes colour according to the power consumption,
    power export, or Agile price at the current time.
    
    The more energy that's being consumed (or generated) the faster the LED pulses.
    ...
    color is sunshine yellow!

    All data input is received over MQTT, a topic per field required. I chose this
    ...
    prices from Agile and power from EmonCMS, so overall it's a good 'hub'. 
    
    I wrote this script to help my family to be more aware of the current 
    energy consumption, generation and prices. And maybe to create some behaviour
